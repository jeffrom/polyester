...
func TestOpCopy(t *testing.T) {
	...
	t.Run("simple", testOpCopySimple)
	t.Run("change-source", testOpCopyChangeSource)
}

func testOpCopySimple(t *testing.T) {
	tmpdir := testenv.TempPlanDir(t, testenv.Path("testdata", "copy"))
...
func testOpCopyChangeSource(t *testing.T) {
	tmpdir := testenv.TempPlanDir(t, testenv.Path("testdata", "copy"))
	defer testenv.RemoveOnSuccess(t, tmpdir)
